...
If you enjoyed this post, please star, like or recommend! :) Follow me on [Medium](https://medium.com/@eirikkvalheim), [Linkedin](https://github.com/KvalheimRacing/CarND/blob/master/P1_Lane_Lines/writeup_report.md) or [Git](https://github.com/KvalheimRacing) to stay tuned for more self-driving car related awesome stuff! 
